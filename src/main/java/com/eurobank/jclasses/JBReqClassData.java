 ...
 */
public class JBReqClassData extends JMainFileClassData{
    ...
    public Object dataProcessing() {
        ...
        List<DataSetType> dataSetsList = mergedDataSetTypes.get(canonicalName);
        return dataSetsList;
    }

    @Override
    public void buildJFieldsAndJMethods(Object dataSetsList) throws JClassAlreadyExistsException {

        List<DataSetType> data = (List<DataSetType>) dataSetsList;
